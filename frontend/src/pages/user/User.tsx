...
import { logout, getAll, googleLink, unlinkGoogle, githubLink, unlinkGithub } from "../../lib/api";
...
export default function User() {
  ...
  const isFacebookLinked = providers?.includes("facebook");
  ...
  return (
    <div className="user-container">
      ...
      <div className="user-profile">
        ...
        <div className="user-section">
          <button className="user-sign-out-btn" onClick={() => signOut()}>
            Sign out
          </button>
        </div>
      </div>
