    ...
    <div className="dashboard-container">
      <header className="dashboard-header">
        <div className="header-content">
          <h1>Account</h1>
          <button className="sign-out-btn" onClick={() => signOutMutation()}>
            Sign Out
          </button>
        </div>
      </header>
      ...
      <div className="dashboard-grid">
        <div className="dashboard-card stats-card">
          ...
          <div className="stats-content">
            <span className="stats-number">{count || 0}</span>
            <span className="stats-label">USERS IN USER AUTHENTICATION</span>
          </div>
        </div>
        ...
        <div className="dashboard-card profile-card">
          ...
          <div className="card-content">
            ...
            <div className="info-row">
              <span className="info-label">User Since</span>
              <span className="info-value">{new Date(createdAt).toLocaleDateString()}</span>
            </div>
          </div>
        </div>
          ...
          <div className="card-content">
            <div className="danger-row">
              <div className="danger-info">
                ...
                <span className="danger-desc">Permanently remove your account and all data.</span>
              </div>
